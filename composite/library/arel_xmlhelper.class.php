...
{	
	...
	/**
	 * Helper for creating a basic Location Based 3D Movie Texture.
	 * @param String $id Id of the AREL Object
	 * @param String $title Title of the AREL Object to be displayed in the popup (if added) as well as list and map
	...
	/**
	 * Helper for creating a basic Location Based 3D Image.
	 * @param String $id Id of the AREL Object
	 * @param String $title Title of the AREL Object to be displayed in the popup (if added) as well as list and map
	...
	/**
	 * Helper for creating a basic Location Based POI (Textual representation with default design)
	 * @param String $id Id of the AREL Object
	 * @param String $title Title of the AREL Object to be displayed in the popup (if added) as well as list and map
	 * @param Array $location An array given all location parameters (latitude, longitude and altitude)
	...
	static public function createLocationBasedPOI($id, $title, $location, $thumbnail, $icon, $description, $buttons)
	{
	 ...
	 /**
	 * Helper for creating a 360 degree Object (3D Model)
	 * @param String $id Id of the AREL Object
	 * @param String $model Path to the model of the Object or to the zip package holding all the information
	 * @param String $texture Path to the texture of the Object (jpg or png file) 
	...
	/**
	 * Helper for creating a basic Glue 3D Model.
	 * @param String $id Id of the AREL Object
	 * @param String $model Path to the model of the Object or to the zip package holding all the information
	 * @param String $texture Path to the texture of the Object (jpg or png file) 
	 * @param Array $translation An array given all translation parameters x,y,z
	...
	/**
	 * Helper for creating a Glue Movie Texture (Movie overlaid a real world object)
	 * @param String $id Id of the AREL Object
	...
	/**
	 * Helper for creating a screen fixed 3D Model, meaning it is always stuck to the devices screen
	 * @param String $id Id of the AREL Object
	 * @param String $model Path to the model of the Object or to the zip package holding all the information
	 * @param String $texture Path to the texture of the Object (jpg or png file) 
	 ...
	 * @param string $resourcesPath Path to a zip holding all resources (models, images, shader, materials) -> only needed for Model3Ds (optional)
	...
	/**
	 * Create the XML output of the AREL Object and send to junaio
